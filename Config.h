...
const QString messageWrongFileAndPath = "Wrong file and directory chosen";
const QString messageWrongFile = "Wrong file chosen";
const QString messageWrongPath = "Wrong directory chosen";
